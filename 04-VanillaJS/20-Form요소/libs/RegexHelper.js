...
class RegexHelper {
    ...
    /**
     * 값의 존재 여부를 검사한다.
     *  @param {string} selector 검사 할 대상의 CSS 선택자
     ...
     *  @param {int}    compare  검사 대상에 대한 CSS 선택자
    ...
    compareTo(origin, compare, msg) {
        ...
        var src = document.querySelector(origin).value.trim();  // 원본 값을 가져온다.
    ...
    /**
     * 라디오나 체크박스의 최대 선택 갯수를 제한다.
     *  @param {string} selector    검사 할 대상의 CSS 선택자
     *  @param {int}    length      최소 선택 개수
     *  @param {string} msg         검사에 실패할 경우 표시될 메세지
     */
     ...
     *  @param {object} regexExpr   검사 할 정규표현식
     */
