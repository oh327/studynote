...
arr.forEach( (v,i) => {
    if (i == 3) {
        console.log(" --- 반복중단!!!");
        // 콜백함수 역시 함수이므로 break를 사용해서 중단 할 수 없다.
        //break;
        // forEach의 콜백함수에서 반복을 중단하고자 return을 사용할 경우 현재 동작중인 콜백만 종료 될 뿐 전체 반복에는 영향이 없다.
        return;
    }
...
console.log(hello);  // [ 11, 21, 31, 41, 51 ]