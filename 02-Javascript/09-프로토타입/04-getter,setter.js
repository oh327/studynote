function User4() {
    // 멤버변수 정의하기
    // 일반적으로 멤버변수는 일반 변수와 구분하기위해 언더바로 시작하는 이름을 갖는다.
    this._id = null;
    this._email = null;
}
...
Object.defineProperty(User4.prototype, "id" , {
    get : function() {
        console.log("id에 대한 getter 호출 됨");
        // 멤버변수의 값을 반환하는 기능
        // 반환 전에 필요하다면 멤버변수의 값을 가공하여 반환할 수도 있다.
        return this._id;
    },
    set : function(param) {
        console.log("id에 대한 setter 호출 됨");
...
Object.defineProperty(User4.prototype, "email", {
    get : function() {
        console.log("email에 대한 getter 호출 됨");
        return this._email;
    },
    set : function(param) {
        console.log("email에 대한 setter 호출 됨");
        this._email = param;
    }
});
